...
// configuration step. It creates a namespace called `image_histogram`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", image_histogram::cmake::project_name, image_histogram::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", image_histogram::cmake::project_version);
      return EXIT_SUCCESS;
    }
